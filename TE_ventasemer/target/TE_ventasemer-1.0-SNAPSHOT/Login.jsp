...
<html lang="en" data-bs-theme="auto">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="Login" method="post">
            <img class="mb-4" src="https://th.bing.com/th/id/OIP.ByL-ZU1ry2JdHWYWOHe-_AAAAA?rs=1&pid=ImgDetMain" alt="" width="72" height="57">
            <h1 class="h3 mb-3 fw-normal">Login</h1> 

            <div class="form-floating">
                <input type="email" name="coreo" class="form-control" id="floatingInput" placeholder="name@example.com">
