        ...
        try {
            ...
            switch (action) {
                ...
                case "edit":
                    ...
                    lista_productos = daoProducto.getAll(); // Esto debería estar aquí para cargar la lista de productos
                    lista_Clientes = daoCliente.getAll(); // Esto debería estar aquí para cargar la lista de clientes
                    request.setAttribute("venta", venta);
                    request.setAttribute("lista_productos", lista_productos); // Agrega la lista de productos al request
                    request.setAttribute("lista_Clientes", lista_Clientes); // Agrega la lista de clientes al request
                    request.getRequestDispatcher("frmventa.jsp").forward(request, response);
                    break;
